"""
Django settings for FlashMaster project.
...
INSTALLED_APPS = [
    ...
    'django.contrib.staticfiles', # to CSS static files
    'cards', # adds app 'çards' 18.01
]
...
WSGI_APPLICATION = 'FlashMaster.wsgi.application'
